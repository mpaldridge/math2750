...
I am very keen to hear about things you'd like to go through in the lectures. You can  [email me](mailto:m.aldridge@leeds.ac.uk) or post to the Teams discussion board ([see below](#team)).
...
* Assessment 2: Thursday 11 March 1400 (week 7)
* Assessment 3 (Computing Worksheet 2): Thursday 18 March 1400 (week 8)
...
If you there is something in the course you wish to discuss in detail, the place for the is the optional weekly drop-in session. You will have been assigned to one of three groups on Tuesdays or Wednesdays with Nikita Merkulov or me. The drop-in sessions will be run the Microsoft Teams. Your drop-in session would be an excellent place to go if you are having trouble understanding something in the written notes, or if you're struggling on a problem sheet question.
