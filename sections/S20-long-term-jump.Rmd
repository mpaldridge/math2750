...
In the [previous example](#stat-cont-ex), the chain was irreducible and positive recurrent. Hence, $\boldsymbol\pi = (\frac17, \frac27, \frac47)$ is the equilibrium distribution for the chain, and describes the long run proportion of time spent in each state.
:::
