...
```{tikz HSD, echo=FALSE, fig.align="center", fig.width=4, fig.cap="Transition for the healthy--sick--dead chain.", cache = TRUE}
...
```{tikz periods, echo=FALSE, fig.align="center", fig.width=5, fig.cap="Transition for an aperiodic irreducible Markov chain.", cache = TRUE}
\usetikzlibrary{automata}
