...
Here are two extra examples; these also give an idea of how I would expect you to set out your answers to similar problems.
If you think you've already got the hang of this, however, you can press on to [the next subsection](#ruin-probability-solve).
...
Here's another example (or skip ahead, if you think you know what you're doing).
