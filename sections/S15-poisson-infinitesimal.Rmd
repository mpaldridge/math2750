...
* It is possible there will be an arrival, and that probability will be proportional to the length $\tau$ of the time period.
...
It will be helpful for us to use "little-$o$" notation. Here $o(\tau)$ means a term that is of "lower order" compared to $\tau$. Specifically, $o(\tau)$ stands for a function of $\tau$ that tends to $0$ as $\tau \to 0$ even when divided by $\tau$. That is,
...
since $Z$ does not increase provided neither $X$ nor $Y$ increases. We also have
