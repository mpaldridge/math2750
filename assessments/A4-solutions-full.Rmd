...
<span style="color: red;">[1 mark for correct answer. 1 mark for very clear explanation ("very clear" usually requires words as well as maths).]</span>
...
<span style="color: red;">[2 marks for a complete (or *nearly* perfect) answer. 1 mark for genuine good progress in the right direction. 0 marks for handwavy "it ought to be about a third of the way in" nonsense.]</span>
...
<span style="color: red;">Finally, there are three marks for the quality of the explanation:</span>


* <span style="color: red;">0 marks: little explanation, not much writing in words</span>
* <span style="color: red;">1 mark: good explanations, decent amount of writing in words, material in a sensible order</span>
* <span style="color: red;">2 marks: clear explanations throughout, very well structured answer</span>
* <span style="color: red;">3 marks: impeccably well explained answer, as good as this answer sheet if not better. (I'd be suprised if more than half a dozen students were at this level.)</span>
</span>
