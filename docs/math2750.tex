...
\item
  \protect\hyperlink{P03}{\textbf{Problem Sheet }}
\item
...
as we must start from \(i\) and then move from \(i\) to \(j\). Another example would be
...
\[ \mathsf P(2) = \begin{pmatrix} \frac13 & \frac29 & \frac29 & \frac29 \\[0.8ex]
                               \frac29 & \frac13 & \frac29 & \frac29 \\[0.8ex]
                               \frac29 & \frac29 & \frac13 & \frac29 \\[0.8ex]
...
\tightlist
\item
  \textbf{Computational worksheet 1} \href{C1.html}{{[}HTML format{]}} \href{C1.Rmd}{{[}Rmd format{]}}
\end{itemize}
...
\item
  If you are in Leeds, university computers have R and RStudio installed. However, at the time of writing (5 February 2021), all IT clusters on campus are closed. You can see \href{https://leeds.service-now.com/it?id=clusters}{the latest news on cluster availability here}.
\item
