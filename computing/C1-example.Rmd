...
plot(0:N, c(0, X),
  ...
  xlab = "time step, n",
  ylim = c(-N, N),
  # The following `bquote` syntax allows fancy titling but is totally optional
...
Here, we'll try investigating the ruin probability of a gambler's ruin problem. (This is the most complicated of the three suggestions above.)
