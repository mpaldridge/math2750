...
:::: {.myq}
**5.** The infinite rooted binary tree is a graph with no cycles. There is one special vertex, the root 0, that has two edges, and every other edge has three edges. A Markov chain $(X_n)$ starts from 0, then at each time step, takes one of the edges coming out of the current vertex and moves along it to the neighbouring vertex.

```{tikz tree, echo=FALSE, fig.align="center", fig.width=3.5, fig.cap="The first two-and-a-bit levels of the rooted binary tree.", cache = TRUE}
