...
:::: {.subq}
**(d)** By summing the probabilities of all relelvant paths, find the three-step transition probability $p_{13}(3)$.
::::
:::::
...
```{tikz fortyplus, echo=FALSE, fig.align="center", fig.width=4, fig.cap="Transition diagram for the car insurance Markov chain", cache = TRUE}
\usetikzlibrary{automata}
		\begin{tikzpicture}
