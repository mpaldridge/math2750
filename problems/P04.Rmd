...
::: {.myanswers data-latex=""}
*Solution.* 	It's clear that $h_{11} = 1$ and $h_{41} = 0$. Then, by condtioning on the first step, we have
	\begin{gather*}
...
::::: {style="display: flex;"}
::: {}
```{tikz Q45, echo=FALSE, fig.align="center", fig.width=3, fig.cap="Transition diagram for Question 5.", cache = TRUE}
\usetikzlibrary{automata}
...
:::: {.subq}
**(b)** What is the expected time until we hit the first of set $\{2,3\}$?
